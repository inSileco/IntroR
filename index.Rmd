...
- `sf` objects are easy to plot, manipulate, import and export
...
- Canadian provincial boundaries - `MULTIPOLYGON`
- climate data - raster
...
# qc_neigh <- filter(can_sf, NAME_1 %in% neigh)
```
...
mat <- as.matrix(seq(val[1], val[2], length = 500))
